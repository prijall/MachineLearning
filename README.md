...
![Naive Bayes](Photo/image_5_uhsgzr.webp)
...
![alt text](<Photo/Screenshot 2024-01-23 190500.png>)
...
![alt text](Photo/entropy-in-machine-learning6.webp)
...
![alt text](Photo/DecisionTreeCode_Part1.png)

![alt text](Photo/DecisionTree_Part1.png)
...
![alt text](Photo/DecisionTree_part2.png)
...
![alt text](Photo/Example-of-Combining-Decision-Boundaries-Using-an-Ensemble.webp)

- For Regression

![alt text](Photo/Example-of-Combining-Hyperplanes-Using-an-Ensemble.webp)
...
![alt text](Photo/VotingEnsembleClassifier.png)
...
- Below is code snippet:
![alt text](Photo/VotingRegressor.png)
...
![alt text](Photo/LR_From_Scratch.png)

![alt text](Photo/LR_Testing.png)
...
![alt text](Photo/Random-Forest-Algortihm.webp)
...
- Below is code snippet:
![alt text](Photo/FeatureImportance.png)
...
![alt text](Photo/ClusteringInKMeans.png)
![alt text](Photo/ElbowMethodCurve.png)

# Day 21
Today, I did practical implementation of KMeans Clustering from scratch which helped me to strengthen my concept.

- Below is code snippet:
![alt text](Photo/KMeansFromScratch.png)
![alt text](Photo/KMeans_Testing.png)
...
![alt text](Photo/GradientBoostingConcept.png)

![alt text](Photo/GradientBoostingGraph.png)
...
![alt text](Photo/GradientBoostingClassifier_Photo.png)
...
- Below is the code:
![alt text](Photo/SVMClassifier.png)
...
![alt text](Photo/XGBoostRregressor.png)
...
![alt text](Photo/lr_scratch.png)

![alt text](Photo/lr_test.png)
...
- Without Bagging
![alt text](Photo/WithoutBagging.png)

- With Bagging
![alt text](Photo/WithBagging.png)
...
![alt text](Photo/Transformers.png)
 ...
 ![alt text](Photo/FeatureScaling.png)
...
![alt text](Photo/db6-e1584577503359.webp)
